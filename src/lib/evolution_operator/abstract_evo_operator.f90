module mod_abstract_evo_operator
  ...
  contains
    ...
    ! procedure, public, non_overridable :: set_reference_state_pointer
  ...
  abstract interface
    ! subroutine evolve_location(self, conserved_vars, reconstructed_state, reference_state, evolved_state)
...
contains
  ...
  ! subroutine set_conserved_vars_pointer(self, conserved_vars_target, lbounds)
  !   class(abstract_evo_operator_t), intent(inout) :: self
  ...
  ! subroutine set_reference_state_pointer(self, reference_state_target, lbounds)
  !   class(abstract_evo_operator_t), intent(inout) :: self
  !   integer(ik), dimension(3), intent(in) :: lbounds
  !   real(rk), dimension(lbounds(1):, lbounds(2):, lbounds(3):), &
  !                       intent(in), target :: reference_state_target
  !   self%reference_state => reference_state_target
  ! end subroutine
